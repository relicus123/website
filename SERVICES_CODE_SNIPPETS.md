...
const service = servicesData.find(
  (s) => s.slug === "counselling-psychotherapy"
);
...
<section className="bg-gradient-to-b from-emerald-50/50 to-white py-32">
  <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
    ...
    <div>
      ...
      <p className="text-xl text-brand-dark/80 mt-4">Description</p>
      <button className="button-primary mt-8">Action</button>
    </div>
...
<section className="py-20 bg-gradient-to-r from-emerald-50 to-teal-50">
  <div className="max-w-4xl mx-auto px-4 text-center">
    ...
    <p className="text-lg text-brand-dark/70 mb-8">Description text here...</p>
    <div className="flex gap-4 justify-center flex-wrap">
      <button className="button-primary px-8 py-3">Primary Action</button>
